...
Boxplot with eye_color on x axis and height on y axis. 

```{r}
p5 <- mydata %>% ggplot(aes(x = eye_color, y = Height)) +
  geom_boxplot()
figure_file = here("results", "figures", "height-eye_color.png")
ggsave(filename = figure_file, plot=p5) 
```

Scatterplot with weight on x axis and hours_sleep on y axis. 

```{r}
p6 <- mydata %>% ggplot(aes(x = Weight, y = hours_sleep)) + 
    geom_point()
  figure_file = here("results", "figures", "weight-hours_sleep.png")
