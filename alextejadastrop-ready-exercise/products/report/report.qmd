...
author: "Alex Tejada-Strop and Elle Adams"
format:
  html:
...
```{r}
resulttable3 <- readRDS(here::here("results","tables","resulttable3.rds"))
resulttable3
```
...
```{r}
# make the scatter plot (Weight vs BMI)
...
# stop if plot does not exist
if (!exists("p_scatter")) {
  stop("p_scatter does not exist — fix the plot chunk above first.")
}
...
print(file.exists(here::here("results", "figures", "height-weight-stratified.png")))
print(file.exists(here::here("results", "figures", "boxplot_height_by_BMIcat.png")))
print(file.exists(here::here("results", "figures", "scatter_weight_vs_BMI.png")))
print(file.exists(here::here("results", "tables", "summarytable.rds")))
print(file.exists(here::here("results", "tables", "resulttable2.rds")))
...
Two new variables were added to the dataset.
The numeric variable, hours_sleep, measures the number of hours each person sleeps per night.
The categorical variable, eye_color, groups individuals by eye color.
...
#| echo: FALSE
summarytable <- readRDS(here::here("results","tables","summarytable.rds"))


## Exploratory figures

### Height by BMI category

knitr::include_graphics(here::here("results","figures","boxplot_height_by_BMIcat.png"))

## Weights vs BMI

knitr::include_graphics(here::here("results","figures","scatter_weight_vs_BMI.png"))
...
#| echo: FALSE
knitr::include_graphics(here::here("results","figures","height-weight-stratified.png"))
...
```{r}
#| label: fig-height-weight-stratified
#| fig-cap: "Height and weight stratified by gender."
#| echo: FALSE
knitr::include_graphics(here::here("results","figures","height-weight-stratified.png"))
